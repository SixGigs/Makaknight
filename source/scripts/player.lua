...
function Player:init(x, y, gm, face)
	...
	self:addState("dead", 42, 42)
	self:addState("idle", 1, 8, {tickStep = 3})
	self:addState("walk", 9, 14, {tickStep = 3})
	self:addState("run", 18, 23, {tickStep = 3})
	self:addState("dash", 34, 36, {tickStep = 1})
	self:addState("ready", 24, 33, {tickStep = 3})
	self:addState("dive", 37, 38, {tickStep = 1})
	self:addState("die", 39, 42, {tickStep = 2})
	self:addState("roll", 43, 50, {tickStep = 2})
