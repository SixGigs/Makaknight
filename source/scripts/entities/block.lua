...
--- Initialise the Block object an X & Y value, and an entity
...
function Block:init(x, y, e)
	-- Initialise the object with the animated sprite library
	Block.super.init(self, gfx.imagetable.new('images/entities/animated/' .. e.name .. '-block-table-32-32'))
...
function Block:obstructed() return self.buffer > 0 end
...
function Block:handleCollision(e, collision)
